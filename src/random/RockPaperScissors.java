...
public class RockPaperScissors extends JPanel implements ActionListener{
    ...
    public void run(){
		...
		try {
			...
			rockImage = new ImageIcon(getClass().getResource("sOl5FSw.gif"));
			paperImage = new ImageIcon(getClass().getResource("download.jpg"));
			scissorsImage = new ImageIcon(getClass().getResource("download-1.jpg"));
